...
#define ENCODE_QUADRATURE 4
extern volatile float ENCODER_KRESOL;
...
extern uint16_t encoder_PPR;
extern float longitudArcoPorResolucion;


extern uint16_t EEMEM EEMEM_encoder_PPR;
extern float EEMEM EEMEM_longitudArcoPorResolucion;
